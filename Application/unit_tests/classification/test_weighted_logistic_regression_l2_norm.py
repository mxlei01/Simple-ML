...
class TestWeightedLogisticRegressionL2Norm(unittest.TestCase):
    #   Usage:
    #       Tests for the Weighted Logistic Regression Class L2 Norm
    ...
    def test_01_gradient_ascent(self):
        # Usage:
        #       Test out the gradient ascent algorithm for weighted logistic regression l2 norm
        # Arguments:
        #       None
        ...
        coefficients = self.weighted_logistic_regression_l2_norm.fit(feature_matrix, sentiment,
                                                                     initial_coefficients=np.zeros(194),
                                                                     weights_list=weights_list,
                                                                     step_size=1e-7, l2_penalty=10, max_iter=30)
    ...
    def test_02_adaboost(self):
        # Usage:
        #       Test out the adaboost algorithm with a weighted logistic regression l2 norm
        # Arguments:
        #       None
