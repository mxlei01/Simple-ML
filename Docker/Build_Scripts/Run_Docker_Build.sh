...
cd /application/Application/ && chmod -R -x * && nosetests -c ../.noserc --with-coverage unit_tests && COVERALLS_REPO_TOKEN=$1 TRAVIS_BRANCH=$2 BRANCH=$3 coveralls --rcfile=../.coveragerc
